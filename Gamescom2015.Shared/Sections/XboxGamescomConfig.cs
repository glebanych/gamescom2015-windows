...
{
    public class XboxGamescomConfig : SectionConfigBase<TwitterDataConfig, TwitterSchema>
    {
        ...
        public override NavigationInfo ListNavigationInfo
        {
            get 
            {
                return NavigationInfo.FromPage("XboxGamescomListPage");
            }
        }
