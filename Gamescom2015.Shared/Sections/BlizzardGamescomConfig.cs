...
{
    public class BlizzardGamescomConfig : SectionConfigBase<TwitterDataConfig, TwitterSchema>
    {
        ...
        public override NavigationInfo ListNavigationInfo
        {
            get 
            {
                return NavigationInfo.FromPage("BlizzardGamescomListPage");
            }
        }
